...
(function (i, e) {
    ...
    function m() {
        if (!q) {
            q = {
                ...
                map: { mapTypeId: google.maps.MapTypeId.ROADMAP, center: [5.575650, -0.243020], zoom: 2 },
    ...
    function a(R, J, L) {
        var P = {},
            N = this,
            O,
            Q = { latLng: { map: false, marker: false, infowindow: false, circle: false, overlay: false, getlatlng: false, getmaxzoom: false, getelevation: false, streetviewpanorama: false, getaddress: true }, geoloc: { getgeoloc: true } };
        if (typeof L === "string") {
            L = K(L);
        }
        function K(T) {
    ...
    function I(O, N, M, J) {
        ...
        this.onAdd = function () {
            ...
            i.each("dblclick click mouseover mousemove mouseout mouseup mousedown".split(" "), function (R, Q) {
                K.push(
                    google.maps.event.addDomListener(J[0], Q, function (S) {
            ...
            K.push(
                google.maps.event.addDomListener(J[0], "contextmenu", function (Q) {
    ...
    function z(ab, al, O, X) {
        ...
        function Q() {
            ...
            W = true;
            K.push(
                google.maps.event.addListener(al, "zoom_changed", function () {
                    ai();
                })
            );
            K.push(
                google.maps.event.addListener(al, "bounds_changed", function () {
                    ai();
                })
            );
            ad();
        ...
        function P() {
            var an = J(al.getCenter(), al.getBounds().getNorthEast()),
                ao = new google.maps.Circle({ center: al.getCenter(), radius: 1.25 * an });
            return ao.getBounds();
        }
        function U() {
            var ao = {},
    ...
    function H(R, J, M, Q, N) {
        var L = M ? k(Q.todo, false, true) : false,
            P = L ? { latLng: L } : Q.todo.address ? (typeof Q.todo.address === "string" ? { address: Q.todo.address } : Q.todo.address) : false,
            K = P ? t.get(P) : false,
            O = this;
        if (P) {
            N = N || 0;
    ...
    function A(R) {
        ...
        this.overlay = function (Y, X) {
            var aa,
                Z,
                W = i(document.createElement("div")).css("border", "none").css("borderWidth", "0px").css("position", "absolute");
        ...
        this.groundoverlay = function (W) {
            ...
            var Y,
                X = new q.classes.GroundOverlay(W.opts.url, W.opts.bounds, W.opts.opts);
            X.setMap(L);
        ...
        this.streetviewpanorama = function (W) {
            ...
            var Y,
                X = new q.classes.StreetViewPanorama(W.opts.container, W.opts.opts);
            if (X) {
                L.setStreetView(X);
            }
        ...
        function U(Y) {
            ...
            ac.display(function (ad) {
                ...
                if (ag) {
                    ...
                    aj = i.extend({}, W);
                    aj.options = i.extend({ pane: "overlayLayer", content: ag.content ? ag.content.replace("CLUSTER_COUNT", af) : "", offset: { x: ("x" in ai ? ai.x : ai[0]) || 0, y: ("y" in ai ? ai.y : ai[1]) || 0 } }, W.options || {});
                    ah = Q.overlay({ todo: aj, opts: aj.options, latLng: k(ad) }, true);
                    aj.options.pane = "floatShadow";
                    aj.options.content = i(document.createElement("div"))
                        .width(ag.width + "px")
                        .height(ag.height + "px");
        ...
        this.directionsrenderer = function (W) {
            W.opts.map = L;
            var Y,
                X = new google.maps.DirectionsRenderer(W.opts);
            if (W.todo.divId) {
